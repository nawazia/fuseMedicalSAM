...
from segment_anything import sam_model_registry_sam4med
...
sam_model = sam_model_registry_sam4med[args.model_type](checkpoint=args.checkpoint, device = args.device).to(
    args.device
)
